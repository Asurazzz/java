...
//        Map<String, Float> times = getTimes();
        Map<String, Float> month = getMonth();
        Map<String, Float> days = getDays();

        for (Map.Entry<String,Float> m : month.entrySet()) {
            for (Map.Entry<String,Float> d : days.entrySet()) {
                if (m.getValue() + d.getValue() == 2.4f) {
                    System.out.println(m.getKey() + ":" + m.getValue() + "=========" + d.getKey() + ":" + d.getValue());
                }
            }
        }
    }
    ...
    public static Map<String,Float> getMonth() {
        Map<String,Float> month = new HashMap<>();
        month.put("正月", 0.6f);month.put("二月", 0.7f);month.put("三月", 1.8f);month.put("四月", 0.9f);
        month.put("五月", 0.5f);month.put("六月", 1.6f);month.put("七月", 0.9f);month.put("八月 ", 1.5f);
        month.put("九月", 1.8f);month.put("十月", 0.8f);month.put("冬月", 0.9f);month.put("腊月", 0.5f);
        return month;

    }

    public static Map<String,Float> getDays() {
        Map<String,Float> days = new HashMap<>();
        days.put("初一", 0.5f);days.put("初二", 1.0f);days.put("初三", 0.8f);days.put("初四", 1.5f);
        days.put("初五", 1.6f);days.put("初六", 1.5f);days.put("初七", 0.8f);days.put("初八", 1.6f);
        days.put("初九", 0.8f);days.put("初十", 1.6f);days.put("十一", 0.9f);days.put("十二", 1.7f);
        days.put("十三", 0.8f);days.put("十四", 1.7f);days.put("十五", 1.0f);days.put("十六", 0.8f);
        days.put("十七", 0.9f);days.put("十八", 1.8f);days.put("十九", 0.5f);days.put("二十", 1.5f);
        days.put("廿一 ", 1.0f);days.put("廿二", 0.9f);days.put("廿三 ", 0.8f);days.put("廿四 ", 0.9f);
        days.put("廿五", 1.5f);days.put("廿六", 1.8f);days.put("廿七 ", 0.7f);days.put("廿八 ", 0.8f);
        days.put("廿九 ", 1.6f);days.put("三十 ", 0.6f);
        return days;
